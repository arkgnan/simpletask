@extends('layouts.fullscreen-layout', ['title' => 'Sign In'])
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-2xl font-semibold text-white dark:text-gray-900">{{ config('app.name') }}</span>
                        </div>
                        <p class="text-center text-gray-400 dark:text-white/60">
                            DATAMINE - Jr Web App Engineer - 1st Technical Test
                        </p>
                    </div>
                </div>
            </div>
