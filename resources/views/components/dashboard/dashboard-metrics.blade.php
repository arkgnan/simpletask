...
<div class="grid grid-cols-1 gap-4 sm:grid-cols-3 md:gap-6">
    ...
    >
      ...
      <div class="flex items-end justify-between mt-5">
        <div>
          ...
          <h4 class="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">{{ $users->count() }}</h4>
        </div>
      </div>
    </div>
    ...
    >
      ...
      <div class="flex items-end justify-between mt-5">
        <div>
          ...
          <h4 class="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">{{ $tasks->count() }}</h4>
        </div>
      </div>
    </div>
    ...
    >
      ...
      <div class="flex items-end justify-between mt-5">
        <div>
          <span class="text-sm text-gray-500 dark:text-gray-400">Today's weather</span>
          <h4 class="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90" id="weather-description">...</h4>
        </div>

        <span
          class="flex items-center gap-1 rounded-full bg-brand-50 py-0.5 pl-2 pr-2.5 text-sm font-medium text-brand-600 dark:bg-brand-500/15 dark:text-brand-500"
        >
            Temp: <span id="weather-temperature">0</span>°C
        </span>
      </div>
    </div>
  </div>
